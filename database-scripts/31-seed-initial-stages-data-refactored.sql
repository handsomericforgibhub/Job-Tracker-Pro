-- Seed Initial Stages Data (Refactored to use central configuration)
...
-- =============================================
-- 1. INSERT THE 12 STAGES FROM CENTRAL CONFIG
-- =============================================

-- Note: These IDs and data should match exactly with /src/config/stages.ts
-- If you need to update stage definitions, update both the TypeScript config AND this script
...
-- =============================================
-- 2. INSERT STAGE QUESTIONS (from STAGE_QUESTIONS)
-- =============================================
...
-- =============================================
-- 3. INSERT STAGE TRANSITIONS (from STAGE_TRANSITIONS)
-- =============================================
...
-- 1. Update /src/config/stages.ts first
-- 2. Run the updated load-stages API endpoint to sync database
-- 3. OR create new migration script with the changes
-- 4. Ensure colors, names, and IDs match between TypeScript and SQL

-- This refactored script maintains the same functionality as the original
-- but includes clear comments linking it to the central configuration
-- making it easier to maintain consistency across the codebase.