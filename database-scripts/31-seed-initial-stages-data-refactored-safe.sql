-- Seed Initial Stages Data (Refactored - Safe Version)
-- This script uses constants that match the central TypeScript configuration
-- Safe version that handles existing data gracefully
...
-- Clear existing stage data to avoid conflicts
DELETE FROM stage_transitions WHERE from_stage_id LIKE '550e8400-e29b-41d4-a716-4466554400%';
DELETE FROM stage_questions WHERE stage_id LIKE '550e8400-e29b-41d4-a716-4466554400%';
DELETE FROM task_templates WHERE stage_id LIKE '550e8400-e29b-41d4-a716-4466554400%';
DELETE FROM job_stages WHERE id LIKE '550e8400-e29b-41d4-a716-4466554400%';

-- =============================================
-- 2. INSERT THE 12 STAGES FROM CENTRAL CONFIG
-- =============================================

-- Note: These IDs and data should match exactly with /src/config/stages.ts
-- Stage ID Constants (matching src/config/stages.ts STAGE_IDS)
...
-- =============================================
-- 3. INSERT STAGE QUESTIONS (from STAGE_QUESTIONS)
-- =============================================
...
-- =============================================
-- 4. INSERT STAGE TRANSITIONS (from STAGE_TRANSITIONS)
-- =============================================
...
-- =============================================
-- 6. UPDATE PLATFORM SETTINGS (Safe Upserts)
-- =============================================

-- Use INSERT ... ON CONFLICT to safely handle existing settings
...
SELECT COUNT(*) as stages_created FROM job_stages WHERE id LIKE '550e8400-e29b-41d4-a716-4466554400%';

-- Verify questions were created
SELECT COUNT(*) as questions_created FROM stage_questions WHERE stage_id LIKE '550e8400-e29b-41d4-a716-4466554400%';

-- Verify transitions were created
SELECT COUNT(*) as transitions_created FROM stage_transitions WHERE from_stage_id LIKE '550e8400-e29b-41d4-a716-4466554400%';

-- Verify task templates were created
SELECT COUNT(*) as task_templates_created FROM task_templates WHERE stage_id LIKE '550e8400-e29b-41d4-a716-4466554400%';

-- Show the stages that were created
SELECT id, name, sequence_order, color, maps_to_status FROM job_stages WHERE id LIKE '550e8400-e29b-41d4-a716-4466554400%' ORDER BY sequence_order;